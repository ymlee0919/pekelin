...
const NewOffer = () => {
    ...
    const refOffer = useRef<OfferInfo>(offer);
    ...
    const onItemsUpdated = () => {
        ...
        if(refOffer.current.Items.length > 0)
            clearErrors("items");
        else
            setError("items", { message: "The offer must have at least one item" });
    }
    ...
    useEffect(() => {
        ...
        return () => { offer = new OfferInfo(); refOffer.current = offer; }
    }, []);
    ...
    const onSumbit = async (data: OfferInfoForm) => {
		...
		let result = await stores.offersStore.create(offer.DTO);
                ...
                <form>
                                ...
                                <label className="label cursor-pointer">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            offer.showHome = e.target.checked;
                                        }} />
                    ...
                    <input 
                        ...
                        {...register("items", {
                            ...
                            valueAsNumber: true,
                            min: {
                                value: 1, message: 'The offer must have at least one item'}
                            }
                        )}
                    />
                </form>
